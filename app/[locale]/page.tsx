...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero Section with Haiti Background */}
      <div className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/haiti-hero-bg.jpg"
            alt="Haiti Landscape"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex gap-4 justify-center">
              <Link href="/apply">
                <Button size="lg" className="shadow-xl hover:scale-105 transition-transform">
                  {t("nav.apply")}
                </Button>
              </Link>
              <Link href="/partners">
                <Button size="lg" variant="outline" className="bg-white/10 backdrop-blur-sm border-white/30 text-white hover:bg-white/20 shadow-xl">
                  {t("nav.partners")}
                </Button>
              </Link>
            </div>
